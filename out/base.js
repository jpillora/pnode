...
var Base, DynamicExposed, EventEmitter2, Logger, RPC_ID, RemoteContext, addr, addrs, crypto, guid, ips, name, os, transportMgr, util, _, _i, _len, _ref, _ref1,
...
Base = (function(_super) {
  ...
  Base.prototype.unbind = function() {
    var conn, _j, _len1, _ref2,
      _this = this;
    if (!this.isBound || this.unbinding) {
      return;
    }
    this.unbinding = true;
    _ref2 = Array.prototype.slice.call(this.connections);
    for (_j = 0, _len1 = _ref2.length; _j < _len1; _j++) {
      conn = _ref2[_j];
      conn.unbind();
    }
    this.tInterface.unbind(function() {
      _this.unbinding = false;
  ...
  Base.prototype.setIsBound = function(flag) {
    this.isBound = flag;
    return this.emit((flag ? '' : 'un') + 'bound');
  };
