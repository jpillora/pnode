...
var clientToken, filterRequest, pkg, serverToken, types, util, _;
...
filterRequest = function(req) {
  return (!serverToken || serverToken === req.headers['pnode-token']) && /^pnode\/0\.\d+.\d+$/.test(req.headers['user-agent']);
};
